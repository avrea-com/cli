...
- `--os-version <CHOICE>` — Guest OS version (e.g. ubuntu-22.04). Defaults to the latest version for the chosen --os. _(choices: `ubuntu-22.04`, `ubuntu-24.04`, `macos-26`, `windows-2025`)_
